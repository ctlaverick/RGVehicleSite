...
const Accessibility = () => (
  <div className="p-8 text-left">
    <h1 className="text-3xl font-bold mb-4 text-center">Accessibility Information</h1>

    <p className="mb-4">
      At CarSubscription.com, we are committed to ensuring digital accessibility for people with disabilities. We continually improve the user experience for everyone and apply relevant accessibility standards.
    </p>
    ...
    <p className="mb-4">
      We welcome your feedback on the accessibility of CarSubscription.com. If you encounter any barriers, please contact us:
      <br />
      Email: <a href="mailto:accessibility@carsubscription.com" className="text-blue-600 underline">accessibility@carsubscription.com</a><br />
      Phone: (123) 456-7890
    </p>
